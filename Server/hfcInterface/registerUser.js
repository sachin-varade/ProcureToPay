...
var registerUser = function(ca, admin, enrollmentID, affiliation, mspid) {    
    ...
    return Fabric_Client.newDefaultKeyValueStore({ path: store_path
        ...
        fabric_ca_client = new Fabric_CA_Client(ca.url, null , ca.name, crypto_suite);
        ...
        return fabric_ca_client.register({enrollmentID: enrollmentID, affiliation: affiliation}, admin_user);
    }).then((secret) => {
